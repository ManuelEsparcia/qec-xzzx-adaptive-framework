...
# Script requires these optional deps; skip cleanly when absent.
...
def test_noise_benchmark_script_smoke() -> None:
    """
    Smoke test:
    ...
    """
    tmp_path = _local_tmp_dir("week1_p2_smoke_")
...
def test_invalid_shots_fail() -> None:
    """
    Must fail with invalid shots (<=0).
    """
    tmp_path = _local_tmp_dir("week1_p2_invalid_")
